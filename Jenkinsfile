    ...
    stages{
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'wookee-mac1', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yml'
             }
        }
